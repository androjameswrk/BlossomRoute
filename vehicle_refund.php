...
<head>
    ...
    <title>Vehicle Rider - Refunds</title>
...
<div class="searchbar2">
    ...
    <div class="report-container">
        <div class="report-header">
            <h1 class="recent-Articles">Refund Orders</h1>
        ...
        <thead>         
        <tr>
                <th><h3 class="t-op">Refund ID</h3></th>                      
                <th><h3 class="t-op">User Name</h3></th>
                <th><h3 class="t-op">Address</h3></th>
                <th><h3 class="t-op">Refund Date</h3></th>
                <th><h3 class="t-op">Refund Amount</h3></th>
        ...
        <?php foreach ($users as $user) : ?>
            <tr>
<td style="font-size: 15px"><?php echo $user['refund_id']; ?></td>
<td style="font-size: 15px"><?php echo $user['username']; ?></td>
<td style="font-size: 15px"><?php echo $user['address']; ?></td>
<td style="font-size: 15px"><?php echo $user['refund_date']; ?></td>
<td style="font-size: 15px"><?php echo $user['refund_amount']; ?></td>
